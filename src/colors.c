...
/* Standard Amstrad CPC Gate Array hardware colour table (firmware colour numbers 0-31).
 * The CPC uses a 3-level DAC per channel: 0=off (0x00), 1=medium (0x20), 2=bright (0x3f).
 * Values in 6-bit (0-63) to match the existing scale6to8() path in platform.c.
 * Reference: CPCWiki "CPC Palette" and Amstrad CPC Technical Reference Manual. */
long ColorRGBs [32][3] = {
  /* 0  White (medium grey) */ { 0x20, 0x20, 0x20 },
  /* 1  White (dup)         */ { 0x20, 0x20, 0x20 },
  /* 2  Sea Green           */ { 0x00, 0x3f, 0x20 },
  /* 3  Lime                */ { 0x3f, 0x3f, 0x20 },
  /* 4  Blue                */ { 0x00, 0x00, 0x20 },
  /* 5  Purple              */ { 0x3f, 0x00, 0x20 },
  /* 6  Cyan                */ { 0x00, 0x20, 0x20 },
  /* 7  Pink                */ { 0x3f, 0x20, 0x20 },
  /* 8  Bright Red          */ { 0x3f, 0x00, 0x00 },
  /* 9  Bright Magenta      */ { 0x3f, 0x00, 0x3f },
  /* 10 Bright Green        */ { 0x00, 0x3f, 0x00 },
  /* 11 Bright Yellow       */ { 0x3f, 0x3f, 0x00 },
  /* 12 Black               */ { 0x00, 0x00, 0x00 },
  /* 13 Bright Red (dup)    */ { 0x3f, 0x00, 0x00 },
  /* 14 Bright Yellow (dup) */ { 0x3f, 0x3f, 0x00 },
  /* 15 Bright White        */ { 0x3f, 0x3f, 0x3f },
  /* 16 Black (dup)         */ { 0x00, 0x00, 0x00 },
  /* 17 Sea Green (dup)     */ { 0x00, 0x3f, 0x20 },
  /* 18 Bright Green (dup)  */ { 0x00, 0x3f, 0x00 },
  /* 19 Bright Cyan         */ { 0x00, 0x3f, 0x3f },
  /* 20 Black (dup)         */ { 0x00, 0x00, 0x00 },
  /* 21 Bright Blue         */ { 0x00, 0x00, 0x3f },
  /* 22 Green               */ { 0x00, 0x20, 0x00 },
  /* 23 Sky Blue            */ { 0x00, 0x20, 0x3f },
  /* 24 Mauve               */ { 0x20, 0x00, 0x20 },
  /* 25 Pastel Green        */ { 0x20, 0x3f, 0x20 },
  /* 26 Lime Green          */ { 0x20, 0x3f, 0x00 },
  /* 27 Pastel Blue         */ { 0x20, 0x20, 0x3f },
  /* 28 Dark Red            */ { 0x20, 0x00, 0x00 },
  /* 29 Violet              */ { 0x20, 0x00, 0x3f },
  /* 30 Dark Yellow         */ { 0x20, 0x20, 0x00 },
  /* 31 Pastel Blue (dup)   */ { 0x20, 0x20, 0x3f },
};
